...
class CommissionService {
  ...
  Future<double> calculateCommission(
    ...
    // Buscar regla específica para el vendedor
    ...
    // Buscar regla general de la empresa
    ...
    if (generalRuleResult.isNotEmpty) {
      final rate = (generalRuleResult.first['commission_rate'] as num).toDouble();
      return saleAmount * (rate / 100);
    }
  ...
  /// Genera automáticamente comisiones para una venta
  Future<int> generateCommissionForSale(
    ...
    final commissionRate = await calculateCommission(db, companyId, salespersonId, saleAmount);
