...
class _MenuPrincipalState extends State<MenuPrincipal> {
  ...
  void _showCommandPalette(
    ...
    var query = _globalSearchController.text;
    showDialog<void>(
      context: context,
      builder: (dialogContext) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            final commands = _filteredCommands(modules, query);
            return AlertDialog(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    _openModule(context, command.module);
                                  },
                                );
                              },
                            ),
  ...
  List<_WorkspaceCommand> _filteredCommands(
    List<ModuleDefinition> modules,
    String query,
  ) {
