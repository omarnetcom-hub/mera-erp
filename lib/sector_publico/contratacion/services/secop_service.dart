...
/// Integración real vía X-Road y API SODA3 de datos.gov.co
library;
...
class SECOPService {
  ...
  Future<ProcesoContratacion> publicarEnSECOP({
    ...
    try {
      ...
      // Llamada a API SECOP II vía X-Road
      final response = await _dio.post(
        '$_xroadServicePath/procesos',
        data: payload,
      );
  ...
  Future<List<Map<String, dynamic>>> recibirOfertasSECOP({
    ...
    try {
      final response = await _dio.get(
        '$_xroadServicePath/procesos/$secopId/ofertas',
      );
  ...
  Future<ProcesoContratacion> publicarAdjudicacionSECOP({
    ...
    try {
      ...
      final response = await _dio.post(
        '$_xroadServicePath/procesos/$secopId/adjudicacion',
        data: payload,
      );
