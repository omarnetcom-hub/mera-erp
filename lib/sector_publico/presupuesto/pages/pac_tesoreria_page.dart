...
class _PACTesoreriaPageState extends State<PACTesoreriaPage> {
  ...
  Future<void> _cargarDatos() async {
    try {
      ...
      _embargos = embargosResult.map((r) => EmbargoJudicial(
        id: r['id'] as String,
          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                ...
                Chip(
                  label: Text(pac.estado.toString().split('.').last.toUpperCase()),
                  backgroundColor: pac.estaAprobado() ? Colors.green : Colors.orange,
      ...
      child: Table(
        ...
        children: [
          TableRow(
            ...
            children: const [
              Padding(padding: EdgeInsets.all(8), child: Text('Mes', style: TextStyle(fontWeight: FontWeight.bold))),
              Padding(padding: EdgeInsets.all(8), child: Text('Programado', style: TextStyle(fontWeight: FontWeight.bold))),
              Padding(padding: EdgeInsets.all(8), child: Text('Ejecutado', style: TextStyle(fontWeight: FontWeight.bold))),
              Padding(padding: EdgeInsets.all(8), child: Text('Saldo', style: TextStyle(fontWeight: FontWeight.bold))),
            ],
          ),
  ...
  void _programarPAC() {
    ...
    final vigenciaController = TextEditingController(text: _vigenciaFiltroController.text);
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: const InputDecoration(labelText: 'Rubro Presupuestal'),
                    items: _rubros.map((r) {
                      return DropdownMenuItem<String>(
                        value: r['codigo_rubro'] as String,
                        child: Text('${r['codigo_rubro']} - ${r['nombre_rubro']}'),
                      );
                    }).toList(),
                    onChanged: (val) {
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Valor Programado'),
                    keyboardType: const TextInputType.numberWithOptions(decimal: true),
                    validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
                  ),
                  TextFormField(
                    controller: funcionarioController,
                    decoration: const InputDecoration(labelText: 'Funcionario que Programa'),
                    validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
                  ),
                ],
              ),
        ...
        content: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                controller: funcionarioController,
                decoration: const InputDecoration(labelText: 'Funcionario que Aprueba'),
                validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
              ),
              TextFormField(
...
foregroundColor: Colors.white,),
  ...
  void _modificarPAC(PAC pac) {
    final formKey = GlobalKey<FormState>();
    final valorController = TextEditingController(text: pac.valorProgramado.toString());
    final funcionarioController = TextEditingController();
    final actoController = TextEditingController();
        ...
        content: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                controller: valorController,
                decoration: const InputDecoration(labelText: 'Nuevo Valor Programado'),
                keyboardType: const TextInputType.numberWithOptions(decimal: true),
                validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
              ),
              TextFormField(
                controller: funcionarioController,
                decoration: const InputDecoration(labelText: 'Funcionario que Modifica'),
                validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
              ),
              TextFormField(
                controller: actoController,
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Monto a Trasladar'),
                    keyboardType: const TextInputType.numberWithOptions(decimal: true),
                    validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
                  ),
                  TextFormField(
                    controller: funcionarioController,
                    decoration: const InputDecoration(labelText: 'Funcionario Autoriza'),
                    validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
                  ),
                  TextFormField(
                    controller: actoController,
              ...
              onPressed: () async {
                if (formKey.currentState!.validate()) {
                  if (mesOrigen == mesDestino) {
                    _mostrarError('El mes de origen y destino deben ser diferentes');
                    return;
                  }
                  Navigator.pop(context);
                  setState(() => _loading = true);
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Número de Proceso'),
                validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
              ),
              TextFormField(
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Nombre del Demandante'),
                validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
              ),
              TextFormField(
                controller: montoController,
                decoration: const InputDecoration(labelText: 'Valor del Embargo'),
                keyboardType: const TextInputType.numberWithOptions(decimal: true),
                validator: (value) => value == null || value.isEmpty ? 'Requerido' : null,
              ),
            ],
