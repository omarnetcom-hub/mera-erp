...
Color _moduleColor(String module) {
  const colors = {
    'accounts_receivable': Color(0xFF118AB2),
    'accounts_payable': Color(0xFFB56576),
    'treasury': Color(0xFF006D77),
    'bank_reconciliation': Color(0xFF588157),
    'tax': Color(0xFFD62828),
    'fixed_assets': Color(0xFF4361EE),
    'crm': Color(0xFF8D5A97),
    'reports': Color(0xFF7B2CBF),
    'sync': Color(0xFF2A9D8F),
    'telemetry': Color(0xFFE9B44C),
    'events': Color(0xFF5E548E),
    'settings': Color(0xFF495057),
  };
