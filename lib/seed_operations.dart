...
void main() async {
  ...
  final dbPaths = [
    r"C:\Users\PC\AppData\Local\Programs\MerkaERP\.dart_tool\sqflite_common_ffi\databases\caja_simple.db",
    r"C:\Users\PC\Desktop\Caja_simple\build\windows\x64\runner\Release\.dart_tool\sqflite_common_ffi\databases\caja_simple.db",
    r"C:\Users\PC\Desktop\.dart_tool\sqflite_common_ffi\databases\caja_simple.db",
    r"C:\Users\PC\Desktop\Caja_simple\.dart_tool\sqflite_common_ffi\databases\caja_simple.db",
  ];
  ...
  for (final dbPath in dbPaths) {
    ...
    try {
      ...
      // 3. Crear Clientes
      final clientsInfo = [
        {'nombre': 'Juan Pérez', 'documento': '1015432120', 'telefono': '3101234567', 'email': 'juan@gmail.com', 'company_id': companyId},
        {'nombre': 'María Gómez', 'documento': '52432981', 'telefono': '3159876543', 'email': 'maria@gmail.com', 'company_id': companyId},
        {'nombre': 'Carlos Rodríguez', 'documento': '80123456', 'telefono': '3204561234', 'email': 'carlos@gmail.com', 'company_id': companyId},
        {'nombre': 'Distribuidora Central', 'documento': '900123456-7', 'telefono': '6013334444', 'email': 'ventas@central.com', 'company_id': companyId},
      ];
      ...
      // 4. Crear Proveedores
      final suppliersInfo = [
        {'nombre': 'Colanta S.A.', 'nit': '890900123-1', 'contacto': 'Ventas Colanta', 'telefono': '6044445555', 'email': 'pedidos@colanta.com.co', 'company_id': companyId},
        {'nombre': 'Nestlé Colombia', 'nit': '860002130-9', 'contacto': 'Pedidos Nestlé', 'telefono': '6012223333', 'email': 'pedidos@nestle.com', 'company_id': companyId},
        {'nombre': 'Alpina Productos Lácteos', 'nit': '860005432-2', 'contacto': 'Logística Alpina', 'telefono': '6018889999', 'email': 'pedidos@alpina.com', 'company_id': companyId},
        {'nombre': 'Molino Tres Castillos', 'nit': '890480020-4', 'contacto': 'Ventas Harina', 'telefono': '6056667777', 'email': 'harinas@trescastillos.com', 'company_id': companyId},
      ];
      ...
      // 5. Crear Productos
      final productsInfo = [
        {'nombre': 'Leche Entera Colanta 1L', 'unidad_base': 'unid.', 'stock': 120.0, 'costo': 2800.0, 'precio': 3800.0, 'impuesto_pct': 19.0, 'codigo_barras': '7702001002003', 'company_id': companyId},
        {'nombre': 'Yogurt Alpina Fresa 150g', 'unidad_base': 'unid.', 'stock': 85.0, 'costo': 1800.0, 'precio': 2600.0, 'impuesto_pct': 19.0, 'codigo_barras': '7702002003004', 'company_id': companyId},
        {'nombre': 'Café Nescafé Tradición 200g', 'unidad_base': 'unid.', 'stock': 4.0, 'costo': 8500.0, 'precio': 12500.0, 'impuesto_pct': 19.0, 'codigo_barras': '7703001004005', 'company_id': companyId},
        {'nombre': 'Harina de Trigo Tres Castillos 1kg', 'unidad_base': 'unid.', 'stock': 2.0, 'costo': 3200.0, 'precio': 4500.0, 'impuesto_pct': 0.0, 'codigo_barras': '7704001005006', 'company_id': companyId},
        {'nombre': 'Aceite de Girasol Gourmet 1L', 'unidad_base': 'unid.', 'stock': 45.0, 'costo': 12000.0, 'precio': 16900.0, 'impuesto_pct': 19.0, 'codigo_barras': '7705001006007', 'company_id': companyId},
        {'nombre': 'Arroz Diana Premium 1kg', 'unidad_base': 'unid.', 'stock': 200.0, 'costo': 2200.0, 'precio': 3200.0, 'impuesto_pct': 0.0, 'codigo_barras': '7706001007008', 'company_id': companyId},
        {'nombre': 'Chocolate Sol 500g', 'unidad_base': 'unid.', 'stock': 60.0, 'costo': 4200.0, 'precio': 5900.0, 'impuesto_pct': 19.0, 'codigo_barras': '7707001008009', 'company_id': companyId},
        {'nombre': 'Queso Doble Crema Colanta 500g', 'unidad_base': 'unid.', 'stock': 30.0, 'costo': 8000.0, 'precio': 11900.0, 'impuesto_pct': 19.0, 'codigo_barras': '7708001009010', 'company_id': companyId},
      ];
      ...
      await db.insert('lotes', {
        ...
        'fecha_vencimiento': DateTime.now().add(const Duration(days: 10)).toIso8601String().split('T').first,
        'cantidad': 50.0,
        'costo': 2800.0,
      ...
      await db.insert('lotes', {
        ...
        'fecha_vencimiento': DateTime.now().add(const Duration(days: 20)).toIso8601String().split('T').first,
        'cantidad': 35.0,
        'costo': 1800.0,
        'created_at': DateTime.now().toIso8601String(),
      });
      ...
      final List<Map<String, dynamic>> ccCaja = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['110505']);
      final List<Map<String, dynamic>> ccBanco = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['111005']);
      final List<Map<String, dynamic>> ccClientes = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['130505']);
      final List<Map<String, dynamic>> ccProveedores = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['220505']);
      final List<Map<String, dynamic>> ccVentas = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['413505']);
      final List<Map<String, dynamic>> ccCostos = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['613505']);
      final List<Map<String, dynamic>> ccInventario = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['143505']);
      final List<Map<String, dynamic>> ccIvaGenerado = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['240805']);
      final List<Map<String, dynamic>> ccIvaDescontable = await db.query('cuentas_contables', where: 'codigo = ?', whereArgs: ['240810']);
      ...
      final int idClientes = ccClientes.isNotEmpty ? ccClientes.first['id'] as int : 3;
      final int idProveedores = ccProveedores.isNotEmpty ? ccProveedores.first['id'] as int : 4;
      final int idVentas = ccVentas.isNotEmpty ? ccVentas.first['id'] as int : 5;
      final int idCostos = ccCostos.isNotEmpty ? ccCostos.first['id'] as int : 6;
      final int idInventario = ccInventario.isNotEmpty ? ccInventario.first['id'] as int : 7;
      final int idIvaGenerado = ccIvaGenerado.isNotEmpty ? ccIvaGenerado.first['id'] as int : 8;
      final int idIvaDescontable = ccIvaDescontable.isNotEmpty ? ccIvaDescontable.first['id'] as int : 9;
      ...
      for (int dayOffset = 360; dayOffset >= 5; dayOffset -= 5) {
        ...
        double saleImpuestos = 0.0;
        double saleCostoTotal = 0.0;
        ...
        for (int i = 0; i < numItems; i++) {
          ...
          final double qty = ((saleCounter + i) % 3) + 1.0;
          final double price = pInfo['precio'] as double;
          final double cost = pInfo['costo'] as double;
          final double taxPct = pInfo['impuesto_pct'] as double;
          
          final double itemSubtotal = qty * price;
          final double itemTax = itemSubtotal * (taxPct / 100);
          final double itemCost = qty * cost;
        ...
        final double saleTotal = saleSubtotal + saleImpuestos;
        ...
        final saleId = await db.insert('ventas', {
          ...
          'costo_unitario': productsInfo.firstWhere((p) => p['nombre'] == saleDetails.first['producto'])['costo'],
          'subtotal': saleSubtotal,
          'impuesto_pct': 19.0,
          'impuesto_total': saleImpuestos,
          'total': saleTotal,
          'fecha': dateStr,
      ...
      for (int dayOffset = 340; dayOffset >= 15; dayOffset -= 25) {
        ...
        final double purchaseTotal = purchaseSubtotal + purchaseImpuestos;
        ...
        final purchaseId = await db.insert('compras', {
          ...
          'impuesto_pct': 19.0,
          'impuesto_total': purchaseImpuestos,
          'total': purchaseTotal,
          'fecha': dateStr,
          ...
          'efectivo': 0.0,
          'transferencia': isCredit ? 0.0 : purchaseTotal,
          'credito': isCredit ? purchaseTotal : 0.0,
      ...
      for (int dayOffset = 300; dayOffset >= 10; dayOffset -= 15) {
        ...
        await db.insert('cierres_caja', {
          'company_id': companyId,
          'fecha': dateStr,
          'saldo_sistema': 350000.0,
          'efectivo_contado': 350000.0,
          'diferencia': 0.0,
          'observacion': 'Desglose: [3x\$50k, 8x\$20k, 4x\$10k]. Cierre de caja operativo exitoso.',
        });
      }
