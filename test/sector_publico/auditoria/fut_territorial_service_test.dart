...
void main() {
  ...
  setUp(() async {
    ...
    futTerritorialService = FUTTerritorialService(db: db, auditoriaService: auditoriaService);
  });
  ...
  test('FUTTerritorialService genera formulario FUT Ingresos y exporta a plano DNP', () async {
    ...
    expect(plano, contains('FUT_DNP_HEADER;ENT-FUT-TEST;2026;T1;futIngresos'));
  });
}
